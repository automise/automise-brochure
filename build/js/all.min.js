function scrollToAnchor(o){var n=$("a[name='"+o+"']");$("html,body").animate({scrollTop:n.offset().top-85},"slow")}$(document).ready(function(){$(window).scroll(function(){$(document).scrollTop()>50?$(".navbar-fixed-top").css("background-color","#c43234").css("height","50").css("padding-top",0):$(".navbar-fixed-top").css("background-color","transparent").css("height","auto").css("padding-top",25)}),$(window).resize(function(){})});
